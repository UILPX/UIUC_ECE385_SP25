...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_text_controller_v1_0_AXI is
  ...
  signal gpu_ready_d : STD_LOGIC;
  signal gpu_ready_d_i_1_n_0 : STD_LOGIC;
  signal \^line_data\ : STD_LOGIC_VECTOR ( 63 downto 0 );
  signal p_0_in : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal p_1_in : STD_LOGIC_VECTOR ( 31 downto 7 );
  signal \p_5_out__0\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \slv_regs[2][3]_i_2_n_0\ : STD_LOGIC;
  signal \slv_regs__0\ : STD_LOGIC_VECTOR ( 31 downto 3 );
  signal slv_regs_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of gpu_ready_d_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of slv_regs : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \slv_regs[2][0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \slv_regs[2][3]_i_2\ : label is "soft_lutpair2";
begin
...
gpu_ready_d_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
gpu_ready_d_reg: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => '1',
...
slv_regs: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
...
\slv_regs[2][3]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\slv_regs[2][3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
hdmi_text_controller_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hdmi_text_controller_v1_0_AXI
     port map (
      ...
      control(3 downto 0) => control(3 downto 0),
      gpu_ready(1 downto 0) => gpu_ready(1 downto 0),
      line_data(63 downto 0) => line_data(63 downto 0)
    );
end STRUCTURE;
library IEEE;
