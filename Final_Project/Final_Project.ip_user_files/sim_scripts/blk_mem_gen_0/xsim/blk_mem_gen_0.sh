...
#
# Generated by Vivado on Mon May 05 12:54:15 -0500 2025
...
simulate()
{
  xsim  blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_lab7_1.protoinst" -log simulate.log
}
