...
#
# Generated by Vivado on Wed May 07 11:26:48 -0500 2025
...
simulate()
{
  xsim  fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_lab7_1.protoinst" -log simulate.log
}
