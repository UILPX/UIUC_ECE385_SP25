...
#
# Generated by Vivado on Fri May 09 06:05:35 -0500 2025
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_lab7_1.protoinst" -log simulate.log
}
