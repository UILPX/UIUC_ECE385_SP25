...
HD_PWD='D:/School/UIUC_ECE385_SP25/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpu_top.tcl
