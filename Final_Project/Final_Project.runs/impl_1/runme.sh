...
HD_PWD='D:/School/UIUC_ECE385_SP25/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpu_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpu_top.tcl -notrace
