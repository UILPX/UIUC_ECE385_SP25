...
HD_PWD='D:/School/UIUC_ECE385_SP25/Final_Project/Final_Project.runs/mb_lab7_1_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab7_1_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lab7_1_dlmb_bram_if_cntlr_0.tcl
