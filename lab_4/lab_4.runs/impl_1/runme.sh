...
HD_PWD='D:/lab_4/lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multipliertop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multipliertop.tcl -notrace
