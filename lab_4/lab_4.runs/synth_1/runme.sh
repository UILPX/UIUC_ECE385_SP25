...
HD_PWD='D:/lab_4/lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multipliertop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multipliertop.tcl
