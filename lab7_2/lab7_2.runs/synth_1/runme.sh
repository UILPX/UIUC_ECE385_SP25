...
HD_PWD='D:/School/UIUC_ECE385_SP25/lab7_2/lab7_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab7_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_lab7_1_wrapper.tcl
