...
#
# Generated by Vivado on Mon Apr 21 18:16:39 -0500 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../hdmi_text_controller_v1_0_project_sim.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../hdmi_text_controller_v1_0_project_sim.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../hdmi_text_controller_v1_0_project_sim.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../hdmi_text_controller_v1_0_project_sim.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
