...
HD_PWD='D:/School/UIUC_ECE385_SP25/lab7_1/lab7_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_lab7_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_lab7_1_wrapper.tcl -notrace
