...
HD_PWD='D:/School/UIUC_ECE385_SP25/gpt_lab4/gpt_lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult8_top.tcl
