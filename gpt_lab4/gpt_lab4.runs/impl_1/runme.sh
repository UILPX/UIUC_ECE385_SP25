...
HD_PWD='D:/School/UIUC_ECE385_SP25/gpt_lab4/gpt_lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult8_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult8_top.tcl -notrace
